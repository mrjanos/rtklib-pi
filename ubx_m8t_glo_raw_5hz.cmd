...
# turn on UBX RXM-RAWX messages on USB interface with the same freq
!UBX CFG-MSG 2 21 0 0 0 1 0 0
# turn on UBX RXM-SFRBX messages on USB interface with the same freq
!UBX CFG-MSG 2 19 0 0 0 1 0 0
# turn on UBX TIM TM2 messages on USB interface with the same freq
